          ...
          <Reveal>
            <IconCards
              items={[
                ...
                { title: "Clear speech", text: "Fixed in place, with no slipping or movement, unlike removable dentures.", icon: MessageCircle },
      ...
      <Section className="bg-[#f4ecdf]">
        <Container>
          <Reveal className="mb-8 max-w-3xl">
            ...
            <h2 className="font-display text-5xl leading-tight text-[#0b1422] sm:text-6xl">
              Matched to how many teeth are missing.
            </h2>
          </Reveal>
          <Reveal>
            <LuxuryAccordion
              items={[
                ...
                { title: "Compromised sites", text: "Bone grafting or sinus augmentation prepares thin or deficient bone before placement.", meta: "03" },
              ]}
            />
          </Reveal>
        </Container>
