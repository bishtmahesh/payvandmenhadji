        ...
        <Container className="grid gap-12 lg:grid-cols-[0.72fr_1.28fr]">
          ...
          <Reveal>
            <p className="max-w-3xl text-xl leading-9 text-[#34383a]">
              Fees are payable at each appointment by card or bank transfer. Many private health insurers contribute towards specialist periodontal and implant care, so please contact your insurer in advance to confirm cover.
            </p>
          </Reveal>
        </Container>
      </Section>
